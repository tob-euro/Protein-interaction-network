...
FULL_GROUPS = {d: f"ind_mm_ldm_seeds=10_latent_dim={d}" for d in DIMS}
II_ONLY_GROUPS = {d: f"iso-iso_ind_mmldm_seeds=10_latent_dim={d}" for d in DIMS}
II_GI_GROUPS = {
    0: "iso-iso_gene-iso_ind_mmldm_withGI_seeds=10_latent_dim=0",
    2: "iso-iso_gene-iso_ind_mmldm_withGI_seeds=10_latent_dim=2",
    8: "iso-iso_gene-iso_ind_m_ldm_seeds=10_latent_dim=8",
    32: "iso-iso_gene-iso_ind_m_ldm_seeds=10_latent_dim=32",
}
